function [GCMat time2use freq2use timeOrder bicMat] = jkGetGrangerLSF(sig1, sig2, FreqRange, FreqScale)
...
szEOI = 29;
thisBuff = 14; %30 % 15 = 500ms

timeSpace = linspace(-500, 2500, size(sig1, 2));
time2use = [0 2000];
